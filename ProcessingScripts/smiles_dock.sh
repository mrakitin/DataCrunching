...
do
  ...
  then
    ...
    pythonsh ../Utilities24/prepare_dpf42.py -l $id.pdbqt -r $1.pdbqt -p ga_run=20 -o $id.dpf
  elif [[ $# -eq 5 ]]
  then
    pythonsh ../Utilities24/prepare_gpf4.py  -l $id.pdbqt -r $1.pdbqt -x $5.pdb -p npts="$4" -p gridcenter="$3" -o $id.gpf
    pythonsh ../Utilities24/prepare_dpf42.py -l $id.pdbqt -r $1.pdbqt -x $5.pdb -p ga_run=20 -o $id.dpf
  else
